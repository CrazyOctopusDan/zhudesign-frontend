      ...
      <div className={styles.aboutMe}>
        ...
        <div className="container">
          <div className="section">
            <div className="cn-intro" dangerouslySetInnerHTML={{__html: cnBrief }}/>
            
            <div className="en-intro" dangerouslySetInnerHTML={{__html: enBrief }}/>
          </div>

          <div className="section">
            <div className="cn-intro cn-award title" dangerouslySetInnerHTML={{__html: cnAward }}/>
            
            <div className="en-intro en-award title" dangerouslySetInnerHTML={{__html: enAward }}/>
          </div>

          <div className="section">
            <div className="cn-intro cn-act title" dangerouslySetInnerHTML={{__html: cnActivities }}/>
            
            <div className="en-intro en-act title" dangerouslySetInnerHTML={{__html: enActivities }}/>
          </div>
